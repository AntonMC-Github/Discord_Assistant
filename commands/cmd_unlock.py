...
def ex(args, message, client, invoke):
    ...
    for role in message.author.roles:
        if role.id == "448428748908396544":
            ...
            yield from client.send_message(message.channel, "Der #team-chat wird nun entsperrt")
            ...
            yield from client.send_message(message.channel, "Der #team-chat wurde nun erfolgreich entsperrt!")
